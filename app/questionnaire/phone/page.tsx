...
export default function PhoneAffordabilityPage() {
  ...
  return (
    <CalculatorLayout
      title="Phone Affordability Calculator"
      description="Find the maximum smartphone budget that comfortably fits your financial situation."
    >
      <ProgressIndicator
        currentStep={1}
        totalSteps={2}
      ...
      {result && (
        <div className="mt-10">
          ...
          <ResultCard
            title="Phone Affordability Report"
            safeEmi={result.safeEmi}
            maxLoan={result.maxLoan}
            assetLabel="Maximum Phone Budget"
